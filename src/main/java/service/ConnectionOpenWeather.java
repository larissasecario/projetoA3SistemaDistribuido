...
public class ConnectionOpenWeather {
    ...
    public static OpenWeather searchOpenWather(String lat, String lon) throws Exception {
        
        String key = "f03bc3941a1a17b8ad431281c40400de";
        String completeUrl = String.format("https://api.openweathermap.org/data/2.5/weather?lat=%s&lon=%s&appid=%s", lat, lon, key);
        int successCode = 200;
